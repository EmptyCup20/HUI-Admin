...
define(['bsTable'], function () {
    var UIKITManage = Backbone.View.extend({
        ...
        render: function () {
            var that = this;
            $.get("/html/uikit/uikit.html").done(function (data) {
                $(".page").html(data);
        ...
        loadTable: function () {
            this.table.bootstrapTable({
                url: window.App.apiIp + "/admin/uikit/getCategory",
                columns: [{
                    field: '_id',
                    visible: false
                }, {
        ...
        addCategory: function () {
            ...
            $.ajax({
                url: window.App.apiIp + "/admin/uikit/addCategory",
                method: "post",
                data: formData
            }).done(function (data) {
                if (data.success) {
        ...
        delCategory: function (e) {
            ...
            $.ajax({
                url: window.App.apiIp + "/admin/uikit/delCategory",
                method: "post",
                data: {
        ...
        saveCategory: function () {
            ...
            $.ajax({
                url: window.App.apiIp + "/admin/uikit/editCategory",
                method: "post",
                data: formData
            }).done(function (data) {
                if (data.success) {
